...
public class UserWebCaller implements IUserAccountService {
    ...
    public boolean addUser(UserAccount userAccount) {
        try {
            ResponseEntity<Boolean> response = restTemplate.postForEntity(userServiceUrl + "/user/add", userAccount, Boolean.class);
    ...
    public boolean updateUser(UserAccount userAccount) {
        try {
            ResponseEntity<Boolean> response = restTemplate.postForEntity(userServiceUrl + "/user/update", userAccount, Boolean.class);
    ...
    public UserAccount getUserById(Integer id) {
        try {
            ResponseEntity<UserAccount> response = restTemplate.getForEntity(userServiceUrl + "/user/get/{id}", UserAccount.class, id);
    ...
    public List<UserAccount> getAllUsers() {
        try {
            ResponseEntity<UserAccount[]> response = restTemplate.getForEntity(userServiceUrl + "/user/getAll", UserAccount[].class);
